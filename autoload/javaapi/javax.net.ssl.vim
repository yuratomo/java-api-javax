...
call javaapi#class('ExtendedSSLSession', 'SSLSession', [
  \ javaapi#method(0,'ExtendedSSLSession(', ')', 'public'),
  \ javaapi#method(0,'getLocalSupportedSignatureAlgorithms(', ')', 'String[]'),
...
call javaapi#class('X509ExtendedTrustManager', 'X509TrustManager', [
  \ javaapi#method(0,'X509ExtendedTrustManager(', ')', 'public'),
  \ javaapi#method(0,'checkClientTrusted(', 'X509Certificate[], String, Socket) throws CertificateException', 'void'),
  \ javaapi#method(0,'checkServerTrusted(', 'X509Certificate[], String, Socket) throws CertificateException', 'void'),
  \ javaapi#method(0,'checkClientTrusted(', 'X509Certificate[], String, SSLEngine) throws CertificateException', 'void'),
