...
call javaapi#class('ExtendedSSLSession', 'SSLSession', [
  \ javaapi#method(0,1,'ExtendedSSLSession(', ')', ''),
  \ javaapi#method(0,1,'getLocalSupportedSignatureAlgorithms(', ')', 'String'),
  \ javaapi#method(0,1,'getPeerSupportedSignatureAlgorithms(', ')', 'String'),
  \ ])
...
call javaapi#class('X509ExtendedTrustManager', 'X509TrustManager', [
  \ javaapi#method(0,1,'X509ExtendedTrustManager(', ')', ''),
  \ javaapi#method(0,1,'checkClientTrusted(', 'X509Certificate[], String, Socket) throws CertificateException', 'void'),
  \ javaapi#method(0,1,'checkServerTrusted(', 'X509Certificate[], String, Socket) throws CertificateException', 'void'),
  \ javaapi#method(0,1,'checkClientTrusted(', 'X509Certificate[], String, SSLEngine) throws CertificateException', 'void'),
  \ javaapi#method(0,1,'checkServerTrusted(', 'X509Certificate[], String, SSLEngine) throws CertificateException', 'void'),
  \ ])
