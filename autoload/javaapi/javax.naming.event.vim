...
call javaapi#interface('EventContext', '', [
...
call javaapi#interface('EventDirContext', '', [
...
call javaapi#interface('NamespaceChangeListener', '', [
...
call javaapi#class('NamingEvent', '', [
...
call javaapi#class('NamingExceptionEvent', '', [
...
call javaapi#interface('NamingListener', '', [
  \ javaapi#method(0,'namingExceptionThrown(', 'NamingExceptionEvent)', 'void'),
  \ ])

call javaapi#interface('ObjectChangeListener', '', [
