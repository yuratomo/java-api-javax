...
call javaapi#class('ServiceRegistry', '', [
  ...
  \ javaapi#method(1,1,'lookupProviders(', 'Class<T>, ClassLoader)', 'Iterator<T>'),
  \ javaapi#method(1,1,'lookupProviders(', 'Class<T>)', 'Iterator<T>'),
  ...
  \ javaapi#method(0,1,'contains(', 'Object)', 'boolean'),
  \ javaapi#method(0,1,'getServiceProviders(', 'Class<T>, boolean)', 'Iterator<T>'),
  \ javaapi#method(0,1,'getServiceProviders(', 'Class<T>, Filter, boolean)', 'Iterator<T>'),
