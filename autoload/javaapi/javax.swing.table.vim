...
call javaapi#class('JTableHeader', '', [
...
call javaapi#class('DefaultTableCellRenderer', '', [
...
call javaapi#class('AccessibleJTableHeaderEntry', '', [
...
call javaapi#class('AccessibleJTableHeader', '', [
  \ javaapi#method(0,'getAccessibleRole(', ')', 'AccessibleRole'),
  \ javaapi#method(0,'getAccessibleAt(', 'Point)', 'Accessible'),
  \ javaapi#method(0,'getAccessibleChildrenCount(', ')', 'int'),
  \ javaapi#method(0,'getAccessibleChild(', 'int)', 'Accessible'),
...
call javaapi#class('TableRowSorterModelWrapper', '', [
...
call javaapi#class('TableRowSorter<M', '', [
