...
call javaapi#interface('XAConnection', 'PooledConnection', [
  \ javaapi#method(0,1,'getXAResource(', ') throws SQLException', 'XAResource'),
  \ ])

call javaapi#interface('XADataSource', 'CommonDataSource', [
  \ javaapi#method(0,1,'getXAConnection(', ') throws SQLException', 'XAConnection'),
  \ javaapi#method(0,1,'getXAConnection(', 'String, String) throws SQLException', 'XAConnection'),
  \ ])
