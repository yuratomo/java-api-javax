...
call javaapi#class('EventReaderDelegate', 'XMLEventReader', [
  \ javaapi#method(0,'EventReaderDelegate(', ')', 'public'),
  \ javaapi#method(0,'EventReaderDelegate(', 'XMLEventReader)', 'public'),
  \ javaapi#method(0,'setParent(', 'XMLEventReader)', 'void'),
  \ javaapi#method(0,'getParent(', ')', 'XMLEventReader'),
...
call javaapi#class('StreamReaderDelegate', 'XMLStreamReader', [
  \ javaapi#method(0,'StreamReaderDelegate(', ')', 'public'),
  \ javaapi#method(0,'StreamReaderDelegate(', 'XMLStreamReader)', 'public'),
  \ javaapi#method(0,'setParent(', 'XMLStreamReader)', 'void'),
  \ javaapi#method(0,'getParent(', ')', 'XMLStreamReader'),
