...
call javaapi#interface('Attributes', 'Serializable', [
  ...
  \ javaapi#method(0,1,'getIDs(', ')', 'String>'),
...
call javaapi#class('BasicAttribute', 'Attribute', [
  ...
  \ javaapi#field(0,0,'values', 'Object>'),
...
call javaapi#interface('DirContext', 'Context', [
  ...
  \ javaapi#method(0,1,'search(', 'Name, Attributes, String[]) throws NamingException', 'SearchResult>'),
  \ javaapi#method(0,1,'search(', 'String, Attributes, String[]) throws NamingException', 'SearchResult>'),
  \ javaapi#method(0,1,'search(', 'Name, Attributes) throws NamingException', 'SearchResult>'),
  \ javaapi#method(0,1,'search(', 'String, Attributes) throws NamingException', 'SearchResult>'),
  \ javaapi#method(0,1,'search(', 'Name, String, SearchControls) throws NamingException', 'SearchResult>'),
  \ javaapi#method(0,1,'search(', 'String, String, SearchControls) throws NamingException', 'SearchResult>'),
  \ javaapi#method(0,1,'search(', 'Name, String, Object[], SearchControls) throws NamingException', 'SearchResult>'),
  \ javaapi#method(0,1,'search(', 'String, String, Object[], SearchControls) throws NamingException', 'SearchResult>'),
  \ ])
