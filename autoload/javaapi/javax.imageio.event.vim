...
call javaapi#interface('IIOReadProgressListener', '', [
...
call javaapi#interface('IIOReadUpdateListener', '', [
...
call javaapi#interface('IIOReadWarningListener', '', [
  \ javaapi#method(0,'warningOccurred(', 'ImageReader, String)', 'void'),
  \ ])

call javaapi#interface('IIOWriteProgressListener', '', [
...
call javaapi#interface('IIOWriteWarningListener', '', [
