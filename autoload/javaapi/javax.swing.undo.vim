...
call javaapi#class('CompoundEdit', '', [
...
call javaapi#class('CannotRedoException', '', [
  \ javaapi#method(0,'CannotRedoException(', ')', 'public'),
  \ ])

call javaapi#class('CannotUndoException', '', [
  \ javaapi#method(0,'CannotUndoException(', ')', 'public'),
  \ ])

call javaapi#class('StateEdit', '', [
...
call javaapi#class('UndoManager', '', [
